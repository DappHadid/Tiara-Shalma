...
const About = () => {
  const skills = [
    ...
    { name: "Canva", level: 87 },
    { name: "3D Blender", level: 90 },
    { name: "Fall in love with Appa", level: 100 },
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16 fade-in-up">
          ...
          <p className="text-xl text-muted-foreground font-inter max-w-3xl mx-auto leading-relaxed">
            As an Interior Design student, I believe that every space tells a story. My mission is to create environments that not only look beautiful
            but also enhance the way people live, work, and connect.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="slide-in-left space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-lg text-foreground font-inter leading-relaxed">
                I approach each project with a deep understanding that great design emerges from the perfect balance of form and function. My work is
                driven by the belief that spaces should inspire, comfort, and elevate the human experience.
              </p>
              <p className="text-lg text-foreground font-inter leading-relaxed">
                Through my studies at Institut Teknologi Nasional, I've developed a comprehensive understanding of spatial relationships, sustainable
                design practices, and the technical expertise needed to bring creative visions to life.
              </p>
            </div>
          ...
          <div className="fade-in-up space-y-8">
            ...
            <p className="text-lg text-muted-foreground font-inter">
              Proficient in industry-standard software with a focus on precision and creative excellence.
            </p>
              ...
              {skills.map((skill, index) => (
                <div key={index} className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-primary font-inter font-semibold">{skill.level}%</span>
                  </div>
