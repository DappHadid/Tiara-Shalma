        ...
        <div className="max-w-4xl mx-auto">
            ...
            {contactInfo.map((item, index) => (
              ...
              >
                ...
                {item.link ? (
                  ...
                  <p className="text-muted-foreground group-hover:text-primary-foreground/80 font-inter">
                    {item.value}
                  </p>
                )}
              </div>
          ...
          <div className="text-center bg-background p-8 rounded-2xl shadow-lg">
            ...
            <p className="text-lg text-muted-foreground font-inter mb-6 max-w-2xl mx-auto">
              Whether you're looking for interior design consultation, collaboration 
              opportunities, or just want to connect with a passionate design student, 
              I'd love to hear from you.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="mailto:inialmeo@gmail.com"
                className="btn-hero inline-flex items-center justify-center no-underline"
              >
          ...
          <div className="mt-12 text-center">
            <blockquote className="text-2xl font-playfair italic text-foreground mb-4">
              "Great design begins with great conversation."
            </blockquote>
            <cite className="text-primary font-inter font-medium">
