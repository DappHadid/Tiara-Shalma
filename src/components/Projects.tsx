...
import fujifilmImage from '@/assets/project-fujifilm.jpg';
  ...
  const projectCategories = [
    {
      ...
      details: 'This introductory course project focuses on creating functional and aesthetically pleasing residential spaces. The design emphasizes open-plan living with careful attention to natural light flow and spatial relationships.',
    },
    {
      id: 'residential-2',
      ...
      perspectives: 10,
      image: residentialImage,
      details: 'Building upon foundational knowledge, this advanced project explores multi-level residential design with sophisticated material palettes and integrated smart home technologies.',
    },
    {
      id: 'fujifilm',
      ...
      perspectives: 6,
      image: fujifilmImage,
      details: 'A modern retail environment designed to showcase FUJIFILM products with interactive display zones, professional lighting systems, and customer experience areas that reflect the brand\'s innovative spirit.',
    },
    {
      id: 'spa',
      ...
      perspectives: 6,
      image: spaImage,
      details: 'A tranquil spa and retail environment that combines aromatherapy retail with wellness treatment spaces, featuring natural materials, soft lighting, and zen-inspired design elements.',
    },
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16 fade-in-up">
          ...
          <p className="text-xl text-muted-foreground font-inter max-w-3xl mx-auto leading-relaxed">
            A curated collection of my interior design work, showcasing 
            technical proficiency and creative problem-solving across 
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-card p-4 rounded-lg border border-border">
                    ...
                    <div className="text-sm text-muted-foreground font-inter">
                      Working Drawing{project.workingDrawings > 1 ? 's' : ''}
                    </div>
                  </div>
                  <div className="bg-card p-4 rounded-lg border border-border">
                    <div className="text-2xl font-playfair font-bold text-primary">
                    ...
                    <div className="text-sm text-muted-foreground font-inter">
                      Perspective Drawing{project.perspectives > 1 ? 's' : ''}
                    </div>
                  </div>
                </div>
